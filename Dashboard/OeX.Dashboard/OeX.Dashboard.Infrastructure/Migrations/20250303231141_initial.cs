        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotivoParadaId1 = table.Column<long>(type: "bigint", nullable: false),
                    EmpresaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaquinaId = table.Column<int>(type: "int", nullable: false),
                    ManagementId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Paradas_MotivosParada_MotivoParadaId1",
                        column: x => x.MotivoParadaId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Paradas_MotivoParadaId1",
                table: "Paradas",
                column: "MotivoParadaId1");
        }
